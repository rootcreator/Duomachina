    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_type', models.CharField(choices=[('image', 'Image'), ('audio', 'Audio'), ('video', 'Video'), ('book', 'Book'), ('manuscript', 'Manuscript'), ('comic', 'Comic')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('issue_number', models.PositiveIntegerField(blank=True, help_text='Issue number for comics', null=True)),
                ('comic_publisher', models.CharField(blank=True, help_text='Publisher of the comic', max_length=255)),
                ('comic_series', models.CharField(blank=True, help_text='Name of the comic series', max_length=255)),
                ('comic_release_date', models.DateField(blank=True, help_text='Release date for comics', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('magazine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='magazine_favorites', to='media.magazine')),
                ('media', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='media_favorites', to='media.media')),
                ('podcast', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='podcast_favorites', to='media.podcast')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_type', models.CharField(choices=[('magazine', 'Magazine'), ('podcast', 'Podcast'), ('media', 'Media')], max_length=10)),
